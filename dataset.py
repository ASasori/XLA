...
class BaseImageDataset(Dataset):
    ...
    def __getitem__(
        ...
        gt_image = cv2.resize(gt_image, target_size, interpolation=cv2.INTER_CUBIC)
        ...
        if self.lr_image_file_names is not None:
            ...
            lr_image = cv2.resize(lr_image, (target_size[0] // self.upscale_factor, target_size[1] // self.upscale_factor), interpolation=cv2.INTER_CUBIC)
